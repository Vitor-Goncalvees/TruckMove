...
<body>
    ...
    <a href="cadastroPedido.php" id="button_cadastro" class="btn btn-outline-success" type="submit" style="background-color: green; color:white;">Cadastrar Pedido</a>
    <br>
