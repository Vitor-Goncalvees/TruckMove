                ...
                if ($result) {
                    ...
                    if ($numRows > 0) {
                        for ($i = 0; $i < $numRows; $i++) {
                            ...
                            echo '<td>';
                            echo '<form action="aceitar_pedido.php" method="post" style="display:inline;">';
                            echo '<input type="hidden" name="pedido_id" value="' . $rows[$i]["id_pedido"] . '">';
                            echo '<button type="submit" class="btn btn-warning">Aceitar Pedido</button>';
                            echo '</form>';
