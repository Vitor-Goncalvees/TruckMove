...
if(isset($_POST['submit'])){
    ...
    */
    ...
    $result = mysqli_query($conexao, "INSERT INTO usuarios(nome,senha,cpf,email,telefone,sexo,data_nasc,cidade,estado,endereco) VALUES ('$nome','$password','$cpf','$email','$tel','$sexo','$data_nasc','$cidade','$estado','$endereco')");
