...
.commitment {
    background-color: #d8e2ff; /* Azul ainda mais claro */
}
                ...
                <section class="cadastrar">
                    <div class="quadrado_azul">
                        <div class="cad-cliente">
                            <img id="cliente" src="Imgs/Icones/entrar.png" alt="celular" style="width:120px;height:auto;">
                                <p class="legenda_cad">Entre com sua conta para pegar mais serviços</p>
                                    <h5 class="subtxt">Confira agora!!!</h5>
                                    <br>                    
                                    <a href="Cliente/View/homeCliente.php">
                    ...
                    <div class="quadrado_azul_2">
                                 <div class="cad-cliente">
                                     <img id="motorista" src="Imgs/perfil/Perfil.png" alt="caminhão" style="width:120px;height:auto;">
                                         <p class="legenda_cad">Cadastre-se como motorista para começar a encontrar serviço</p>
                                             <h5 class="subtxt">Confira agora!!!</h5>
                                                <br>
                                                <a href="Motorista/View/homeMotorista.php">
